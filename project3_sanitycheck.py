...
EXPECTED_OUTPUT_LINES = \
    ...
    make_line_rules(
        [FORMAT_DATE, FORMAT_DECIMAL, FORMAT_DECIMAL, FORMAT_DECIMAL, FORMAT_DECIMAL, FORMAT_INT, FORMAT_EMPTY,
         FORMAT_EMPTY, FORMAT_EMPTY], 4) + \
    make_line_rules(
        [FORMAT_DATE, FORMAT_DECIMAL, FORMAT_DECIMAL, FORMAT_DECIMAL, FORMAT_DECIMAL, FORMAT_INT, FORMAT_DECIMAL,
         [FORMAT_EMPTY, 'BUY', 'SELL'], [FORMAT_EMPTY, 'BUY', 'SELL']], 7)
...
def expect_no_output(process: TextProcess) -> None:
    try:
        ...
        print_labeled_output('ERROR',
                             'No output was expected before the program reads input, but your program printed some')
        raise TestFailure()
